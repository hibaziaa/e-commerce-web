export default function Reviews(){
    return(
        <>
        <div>
            <h1 className="font-bold md:text-5xl md:leading-[57.6px] leading-[36px] text-[32px] uppercase mt-12 mx-4 md:mt-20 md:mx-[100px] h-[72px] w-[286px] md:h-[58px] md:mb-8 md:w-[654px]">
                our happy customers
            </h1>
